...
### What are some examples of sorting algorithms?
  ...
  - **Merge sort** is a divide and conquer algorithm that sorts an array by repeatedly merging two smaller sorted arrays. It is a stable sort, meaning that equal elements remain in the same relative order. Its time complexity is O(n log n).
  ...
  - **Quick sort** is a divide and conquer algorithm that sorts an array by repeatedly partitioning the array into two sub-arrays and sorting them recursively. It is a stable sort, meaning that equal elements remain in the same relative order. Its time complexity is O(n log n).
